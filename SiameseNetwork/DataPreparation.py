...
class DataPrep(object):
    def __init__(self):
        ...
        self.train_set = datasets.Omniglot(root='./omniglotdata', background="tra", download=False,
                                           transform=transform_two)

        # dataset = torchvision.datasets.ImageFolder('omniglotdata/omniglot-py/', transform=transform_two)

        self.val_set = datasets.Omniglot(root='./omniglotdata', background="val", download=False,
                                         transform=transform_two)
        self.test_set = datasets.Omniglot(root='./omniglotdata', background="tes", download=False,
                                          transform=transform_two)
