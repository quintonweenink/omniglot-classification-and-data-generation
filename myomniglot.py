...
from torchvision.datasets.utils import download_url, check_integrity, list_dir, list_files


class MyOmniglot(data.Dataset):
    ...
    zips_md5 = {
        ...
        'images_background_small1': '68d2efa1b9178cc56df9314c21c6e718',
        'images_background_small2': '68d2efa1b9178cc56df9314c21c6e718',
